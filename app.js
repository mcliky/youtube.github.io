...
const searchButton=()=>{
flag=0;
const textSearch=document.querySelector("#txt-search").value;
if(textSearch!=""){
document.querySelector("#results").innerHTML="";
for(let i=0;i<videosList.length;i++){
  if(videosList[i].description.includes(textSearch)){
...
alert("Please enter a keyword");
  ...
  document.querySelector("#results").innerHTML=`<span>No videos found with the keyword ${textSearch}</span>`;
  document.querySelector("#txt-search").value="";
}
}
document.querySelector("#btn-search").addEventListener("click",searchButton);
